<template>
  <el-dialog
    ...
    <el-form-item label="触发的报警规则id" prop="alarmRuleId">
      <el-input v-model="dataForm.alarmRuleId" placeholder="触发的报警规则id"></el-input>
    </el-form-item>
    <el-form-item label="报警值下限" prop="minValue">
      <el-input v-model="dataForm.minValue" placeholder="报警值下限"></el-input>
    </el-form-item>
    <el-form-item label="报警值最大值" prop="maxValue">
      <el-input v-model="dataForm.maxValue" placeholder="报警值最大值"></el-input>
    </el-form-item>
    <el-form-item label="报警时间" prop="alarmTime">
      <el-input v-model="dataForm.alarmTime" placeholder="报警时间"></el-input>
    </el-form-item>
    <el-form-item label="是否已经处理(0/1 否/是)" prop="handled">
      <el-input v-model="dataForm.handled" placeholder="是否已经处理(0/1 否/是)"></el-input>
    </el-form-item>
    <el-form-item label="处理日志id" prop="hangleLogId">
      <el-input v-model="dataForm.hangleLogId" placeholder="处理日志id"></el-input>
    </el-form-item>
    </el-form>
